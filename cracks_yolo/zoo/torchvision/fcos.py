"""FCOS-R50 (torchvision) — own train/inference/save."""
...
class FCOSModel(TorchvisionBase):
    """torchvision FCOS-ResNet50-FPN."""
    ...
    def __init__(self, num_classes: int = 1, input_size: int = 640, logger: Logger = None) -> None:
        ...
        self._inner = fcos_resnet50_fpn(
            weights=FCOS_ResNet50_FPN_Weights.DEFAULT,
            weights_backbone=ResNet50_Weights.IMAGENET1K_V1,
            num_classes=91,
        )
        in_channels = self._inner.head.classification_head.conv[0].in_channels
        num_anchors = self._inner.head.classification_head.num_anchors
        self._inner.head = FCOSHead(
